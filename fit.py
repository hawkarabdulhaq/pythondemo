...
def show():
    ...
    tab1, tab2 = st.tabs(["Individuals", "Enterprises"])
    ...
    with tab2:
        st.markdown("""
        <div class="content">
            For enterprises seeking to enhance their teams’ skills, the Fit Assessment customizes the training experience to meet organizational goals. Equip your team with skills in Python programming, automation, and data analysis to streamline operations and drive innovation.
        </div>
        """, unsafe_allow_html=True)
