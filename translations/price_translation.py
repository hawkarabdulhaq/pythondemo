...
def fetch_translations():
    """
    Fetch translations specific to price keys from the master_translation.csv file.
    """
    translations = {}
    ...
    try:
        with open(csv_file_path, mode='r', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                key = row['Key'].strip()  # Match exact key from CSV
...
price_translations = fetch_translations()
