...
def show():
    ...
    # Render the SVG within a centered container, ensuring no extra margins.
    components.html(
        f"""
        <div style="margin:0; padding:0; width:800px; margin-left:auto; margin-right:auto;">
            {svg_code}
        </div>
        """,
        height=400,  # Matches the SVG height (adjust if needed)
        scrolling=False,
    )
