...
def show():
    ...
    <html>
      <head>
        <meta charset="UTF-8">
        <style>
          /* Remove any default margins and disable overflow */
          html, body {
            margin: 0;
            padding: 0;
            overflow: hidden;
          ...
          /* Make the SVG scale to the container’s width */
          svg {
            width: 100%;
            height: auto;
            display: block;
    ...
    components.html(html_code, height=1000, width=1200, scrolling=False)
    
    # Additional content below the SVG
    st.markdown("""
    <div style="text-align: center; font-size: 1.5em; font-weight: bold; color: #eeeeee; margin: 20px 0;">
