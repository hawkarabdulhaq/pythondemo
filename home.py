...
def show():
    # Add custom CSS to ensure proper SVG rendering
    st.markdown("""
        <style>
        .stMarkdown {
    ...
    # SVG Banner Section with proper container
    svg_code = '''
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450" preserveAspectRatio="xMidYMid meet">
            ...
            <g transform="translate(500, 230)" filter="url(#primaryGlow)">
                <g class="web-elements" opacity="0.6">
                    <text x="0" y="0" font-family="monospace" fill="#818CF8" font-size="14">&lt;div class="impact"&gt;</text>
                    <text x="20" y="25" font-family="monospace" fill="#818CF8" font-size="14">&lt;App /&gt;</text>
                    <text x="0" y="50" font-family="monospace" fill="#818CF8" font-size="14">&lt;/div&gt;</text>
                </g>
            </g>
    ...
    # Rest of your content (What We Offer section, etc.)
    st.markdown("""
