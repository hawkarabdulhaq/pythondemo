...
def show():
    # Banner Section replaced with SVG code
    st.markdown("""
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450"> <!-- Increased height to 450 -->
        <defs>
        ...
        <g transform="translate(400, 360)" filter="url(#primaryGlow)"> <!-- Moved up slightly -->
        ...
        <g transform="translate(400, 420)" filter="url(#primaryGlow)"> <!-- Positioned at the bottom -->
