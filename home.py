...
def show_home():
    # Apply dark theme and custom animated styles.
    apply_dark_theme()      # Ensures the background is dark.
    apply_custom_styles()   # Applies your custom animated styles.
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400">
        ...
        <!-- Pure black background with tech grid -->
    ...
    # Render the SVG using components.html with zero margin/padding.
    components.html(
        f"""
