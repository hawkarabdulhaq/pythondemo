...
def show():
    ...
    st.markdown(
        """
        <style>
            /* Target the main container block (class names may vary with Streamlit versions) */
            .block-container {
                padding-top: 0rem;
                margin-top: 0rem;
            }
    ...
    """
    # Set the iframe height equal to the SVG's natural height (450) and disable scrolling.
