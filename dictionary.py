...
from translations.enrollment_translation import enrollment_translations  # Add enrollment translations
...
translations = {
    ...
    **enrollment_translations,  # Include enrollment translations
}
