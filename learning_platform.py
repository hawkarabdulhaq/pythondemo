...
def show():
    # Define four tabs for Canvas, Course Content, Testimonials, and Course Participants
    tab1, tab2, tab3, tab4 = st.tabs(["Canvas", "Course Content", "Testimonials", "Course Participants"])
