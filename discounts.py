...
def show():
    ...
    <div class="content">
        ...
        <ul>
            ...
            <li><strong>Student Discount for 3rd and 4th Graders</strong>: If you're a 3rd or 4th-year student, you’re eligible for an <strong>80% discount</strong> on the total course price.</li>
        </ul>
        
        <p>For more information, reach out to us at <a href="mailto:connect@habdulhaq.com" target="_blank" style="color: #1ABC9C;">connect@habdulhaq.com</a>.</p>
    </div>
